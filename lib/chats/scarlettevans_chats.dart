...
class ScarlettevansChats extends StatefulWidget {
  const ScarlettevansChats({super.key});

  @override
  State<ScarlettevansChats> createState() => _ScarlettevansChatsState();
}

class _ScarlettevansChatsState extends State<ScarlettevansChats> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: ListTile(
          ...
          subtitle: Text('last seen 4:15 PM'),
        ),
        actions: [
