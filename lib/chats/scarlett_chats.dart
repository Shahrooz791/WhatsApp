...
class ScarlettChats extends StatefulWidget {
  const ScarlettChats({super.key});

  @override
  State<ScarlettChats> createState() => _ScarlettChatsState();
}

class _ScarlettChatsState extends State<ScarlettChats> {
