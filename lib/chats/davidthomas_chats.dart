...
class DavidthomasChats extends StatefulWidget {
  const DavidthomasChats({super.key});

  @override
  State<DavidthomasChats> createState() => _DavidthomasChatsState();
}

class _DavidthomasChatsState extends State<DavidthomasChats> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: ListTile(
          ...
          subtitle: Text('Last Seen 2:00 AM'),
        ),
        actions: [
